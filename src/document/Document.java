...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		if(counter > 1 && charSet[charSet.length - 1] == 'e' && !vowels.contains("" + charSet[charSet.length - 2]))
			counter--;
	...
	{
	    // TODO: You will play with this method in week 1, and then implement it in week 2

		double score = 206.835 - 1.015 * ( (double) this.getNumWords() / (double) this.getNumSentences())
				- 84.6 * ((double) this.getNumSyllables() / (double) this.getNumWords());
