...
public class BasicDocument extends Document 
{
	...
	public int getNumSyllables()
	{
		...
		ArrayList<String> words = (ArrayList<String>) getTokens("[a-zA-z]+");
		
		int totalSyl = 0;
		
		for(String s: words){
			totalSyl += countSyllables(s);
		}
	...
	public static void main(String[] args)
	{
		...
		//String text = "Every sentence contains at least one word.";
		/*String text = "Every sentence contains at least one word. Sorry! Yeah? You mean a word can be a sentece by its own? That's is right.";
